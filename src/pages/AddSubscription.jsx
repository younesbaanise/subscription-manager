...
import { FiPlus, FiArrowLeft, FiDollarSign, FiCalendar, FiCreditCard, FiFileText, FiCheck, FiX } from 'react-icons/fi';
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
          <div className="flex items-center space-x-4">
            <button
              ...
              className="flex items-center justify-center w-10 h-10 bg-gray-100 hover:bg-gray-200 rounded-lg transition-colors cursor-pointer"
            >
              <FiArrowLeft className="w-5 h-5 text-gray-600" />
            </button>
            <div>
              <h1 className="text-xl sm:text-2xl font-bold text-gray-900">Add New Subscription</h1>
              <p className="text-gray-600 text-sm sm:text-base">Track your new subscription service</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="mb-8">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">Fill in the details of your new subscription</p>
              </div>
            </div>
          </div>
