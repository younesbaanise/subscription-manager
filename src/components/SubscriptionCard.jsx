    ...
    <div className={`bg-white rounded-lg shadow-md p-6 border-l-4 ${
      ...
      <div className="flex justify-end space-x-2">
        ...
        <button
          ...
          disabled={isDeleting}
          className="px-4 py-2 text-sm font-medium text-red-600 bg-red-50 rounded-md hover:bg-red-100 focus:outline-none focus:ring-2 focus:ring-red-500 disabled:opacity-50 disabled:cursor-not-allowed"
        >
